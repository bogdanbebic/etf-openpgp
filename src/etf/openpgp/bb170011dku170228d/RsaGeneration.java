...
public class RsaGeneration {
    public static void generateKey(int keySize, String id, char []passphrase) {
        try {
            ...
            ArmoredOutputStream pubout = new ArmoredOutputStream(new FileOutputStream("dummy1public.asc"));
            pkr.encode(pubout);
            pubout.close();
            ArmoredOutputStream secout = new ArmoredOutputStream(new FileOutputStream("dummy1private.asc"));
            skr.encode(secout);
            secout.close();
    ...
    public static PGPKeyRingGenerator generateKeyRingGenerator(int keySize, String id, char[] pass) throws Exception
    {
    ...
    public static PGPKeyRingGenerator generateKeyRingGenerator(int keySize, String id, char[] pass, int s2kcount) throws Exception
    {
